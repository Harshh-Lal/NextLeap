      ...
      <div className="px-margin-page max-w-container-max mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div className="max-w-xl">
            ...
            <h2 className="font-headline-lg-mobile md:font-headline-lg text-3xl md:text-4xl font-bold text-on-surface">The latest from our team.</h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <article className="group cursor-pointer">
            ...
            <h3 className="font-title-md text-lg font-bold text-on-surface mb-2 group-hover:text-on-tertiary-container transition-colors">The Future of Serverless Architecture</h3>
            <p className="font-body-md text-sm text-on-surface-variant">How serverless is evolving and why it matters for scaling startups.</p>
          </article>
          {/* Article 2 */}
          <article className="group cursor-pointer">
            <div className="w-full h-48 bg-surface-container-low rounded-xl mb-4 overflow-hidden relative">
            ...
            <h3 className="font-title-md text-lg font-bold text-on-surface mb-2 group-hover:text-on-tertiary-container transition-colors">Creating Accessible Digital Products</h3>
            <p className="font-body-md text-sm text-on-surface-variant">A comprehensive guide to ensuring your platform is usable by everyone.</p>
          </article>
          {/* Article 3 */}
          <article className="group cursor-pointer">
            <div className="w-full h-48 bg-surface-container-low rounded-xl mb-4 overflow-hidden relative">
            ...
            <h3 className="font-title-md text-lg font-bold text-on-surface mb-2 group-hover:text-on-tertiary-container transition-colors">Digital Transformation in 2026</h3>
            <p className="font-body-md text-sm text-on-surface-variant">Key trends and strategies for modernizing legacy business models.</p>
          </article>
        </div>
      </div>
    </section>
